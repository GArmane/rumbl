defmodule Rumbl.VideoControllerTest do
  ...
  test "lists all user's videos on index", %{conn: conn, user: user} do
    user_video = Helpers.insert_video(user, title: "funny cats")
    other_video = Helpers.insert_video(
      Helpers.insert_user(%{username: "other"}),
      title: "another video"
    )
  ...
  %{user: owner, conn: conn} do
    video = Helpers.insert_video(owner, @valid_attrs)
    non_owner = Helpers.insert_user(%{username: "sneaky"})
